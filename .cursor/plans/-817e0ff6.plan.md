<!-- 817e0ff6-869b-4cfb-b222-b99f85dbb5ca c4daa289-3382-4951-a64f-d96c848554ec -->
...
Причина отсутствия декораторов: эти файлы используют `unittest.TestCase` вместо pytest, поэтому декораторы Allure не применяются.
...
```140:196:tests/integration/test_timezone_integration.py
...
```202:259:tests/integration/test_timezone_integration.py
...
```265:315:tests/integration/test_timezone_integration.py
...
```317:335:tests/integration/test_timezone_integration.py
...
```341:392:tests/integration/test_timezone_integration.py
...
```398:447:tests/integration/test_timezone_integration.py
...
```453:467:tests/integration/test_timezone_integration.py
...
```469:487:tests/integration/test_timezone_integration.py
...
```34:43:tests/unit/test_utils/test_timezone_utils.py
...
```45:52:tests/unit/test_utils/test_timezone_utils.py
...
```54:60:tests/unit/test_utils/test_timezone_utils.py
...
```66:76:tests/unit/test_utils/test_timezone_utils.py
...
```78:87:tests/unit/test_utils/test_timezone_utils.py
...
```93:101:tests/unit/test_utils/test_timezone_utils.py
...
```103:110:tests/unit/test_utils/test_timezone_utils.py
...
```116:124:tests/unit/test_utils/test_timezone_utils.py
...
```126:133:tests/unit/test_utils/test_timezone_utils.py
...
```135:145:tests/unit/test_utils/test_timezone_utils.py
...
```151:160:tests/unit/test_utils/test_timezone_utils.py
...
```166:176:tests/unit/test_utils/test_timezone_utils.py
...
```182:190:tests/unit/test_utils/test_timezone_utils.py
...
```192:198:tests/unit/test_utils/test_timezone_utils.py
...
```200:207:tests/unit/test_utils/test_timezone_utils.py
    def test_current_timestamp(self):
...
```213:239:tests/unit/test_utils/test_timezone_utils.py
...
```241:254:tests/unit/test_utils/test_timezone_utils.py
...
Все эти тесты используют `unittest.TestCase`, поэтому декораторы Allure (`@allure.epic`, `@allure.feature`) не применяются. Согласно правилам из `testing-rules.mdc`, для `unittest.TestCase` декораторы не требуются.