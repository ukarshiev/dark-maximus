# {{PROJECT_NAME}} - Общая информация о проекте
...
**{{PROJECT_NAME}}** — это полнофункциональная система автоматизированной продажи VPN через Telegram с современной веб-панелью управления. Проект разработан для максимальной автоматизации бизнеса по продаже VPN-услуг с использованием панели 3x-ui.
