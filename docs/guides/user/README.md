...
> Дата последней редакции: 13.11.2025 12:59  
> Тип документа: How-to overview
...
- [Docsify Wiki (шаблон)](../../internal/wiki/docsify-overview.md) — как собрать статичную выдачу для пользователей
