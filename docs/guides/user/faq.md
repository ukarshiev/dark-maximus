...
Да! Система поддерживает автоматическое продление ключей:

- **Глобальное автопродление**: Вы можете включить автопродление для всех ваших ключей в разделе "Мой профиль"
- **Индивидуальное автопродление**: Для каждого ключа можно отдельно включить/отключить автопродление в разделе "Мои ключи"
- **Условия**: Автопродление работает только если и глобальное, и индивидуальное автопродление включены, а также при достаточном балансе
- **Контроль**: Вы полностью контролируете автопродление - можете отключить его для конкретного ключа или для всех ключей сразу

За несколько дней до окончания подписки бот также напомнит вам о необходимости продления, даже если автопродление включено.
