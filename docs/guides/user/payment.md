...
> Дата последней редакции: 16.11.2025  
> Тип документа: How-to (billing)
...
### Продление триального ключа

Если вы продлеваете **пробный ключ** (триал) с оплатой:
- Ключ автоматически становится **боевым** (платным)
- Триальный период завершается, ключ получает полный статус платной подписки
- Это гарантирует, что триал работает только 3 дня, как и задумано

### Автопродление подписки

Система поддерживает автоматическое продление ключей с вашего баланса:

#### Глобальное автопродление

Вы можете включить автопродление для всех ваших ключей:
1. Откройте раздел **"Мой профиль"** в боте
2. Найдите настройку **"Автопродление"**
3. Включите автопродление для всех ключей

#### Индивидуальное автопродление для каждого ключа

Для каждого ключа можно отдельно управлять автопродлением:

1. Откройте раздел **"Мои ключи"** в боте
2. Выберите нужный ключ
3. В информации о ключе нажмите кнопку **"🔄 Автопродление: Вкл"** или **"🔄 Автопродление: Выкл"**
4. Статус автопродления отображается в информации о ключе

**Как это работает:**
- Автопродление происходит только если **и глобальное, и индивидуальное автопродление включены**
- Если хотя бы одно из них отключено - автопродление не произойдет
- Продление происходит автоматически с вашего баланса при достаточных средствах
- Вы получите уведомление о списании средств и продлении ключа

**Примеры использования:**
- У вас 3 ключа, но вы хотите продлевать только 2 из них - отключите автопродление для третьего ключа
- Вы хотите временно отключить автопродление для одного ключа, не меняя глобальную настройку
