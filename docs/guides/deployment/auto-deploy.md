...
- **Быстрый старт:** http://localhost:50001/admin/quickstart
- **Полное руководство:** http://localhost:50001/admin/guide
- **Чек-лист безопасности:** http://localhost:50001/admin/security
- **API документация:** http://localhost:50001/admin/api

### Клиентская документация:
- **Главная:** http://localhost:50001/
- **FAQ:** http://localhost:50001/faq
- **Настройка Android:** http://localhost:50001/setup/android
- И т.д.
