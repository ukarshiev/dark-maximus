...
- ✅ Во всех вариантах выводится суффикс (UTC±X)
...
- В тексте уведомления указан суффикс (UTC±X)
...
- После сохранения виден выбранный суффикс (UTC±X) и время пересчитывается
