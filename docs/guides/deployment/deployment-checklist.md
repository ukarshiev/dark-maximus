...
- [ ] Открыты необходимые порты:
  ...
  - `443` (HTTPS)
  - `50000` (основной бот)
- [ ] **НЕ нужно** открывать порты 50001 и 50002 (они доступны только через localhost)
...
# dark-maximus-docs         Up X seconds   0.0.0.0:50001->8080/tcp
# dark-maximus-codex-docs   Up X seconds   0.0.0.0:50002->3000/tcp
```
...
- [ ] Локальные порты для отладки (50001, 50002)
