...
```
docs/
├── guides/user/              # Руководства для клиентов
├── guides/admin/             # Руководства по панели
├── tutorials/                # Туториалы (установка, быстрый старт)
├── reference/admin-panel/    # Справочники (API, клавиатуры)
├── security/security-checklist.md
└── internal/wiki/            # Docsify шаблоны и статичный экспорт
    └── public/               # Файлы, которые отдаёт контейнер docs
```
