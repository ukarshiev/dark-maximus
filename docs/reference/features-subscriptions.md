...
Для ключей с режимами предоставления "Личный кабинет" или "Личный кабинет + Подписка" в клавиатуре управления ключом (`create_key_info_keyboard`) отображается кнопка "🗂️ Личный кабинет".
...
**Расположение кнопки:**
- Кнопка "🗂️ Личный кабинет" отображается **над** кнопками "⚙️ Настройка" и "🔑 Подписка"
...
### Формирование клавиатуры с кнопкой "Личный кабинет"

```python
from shop_bot.bot.keyboards import create_key_info_keyboard

# Кнопка "Личный кабинет" автоматически добавляется если:
