...
> **Примечание:** Подробное описание структуры файлов см. в [README.md](../../video_instructions/README.md)
...
Для обновления видеоинструкций используйте веб-панель администратора:

1. Перейдите в раздел **Инструкции** → вкладка **Видео**
2. Дважды кликните по записи в таблице для редактирования
3. Загрузите новое видео или обновите существующее

> **См. также:** [Настройка и использование видеоинструкций](../guides/admin/video-instructions-setup.md) — Практическое руководство по управлению видеоинструкциями
...
- Файлы доступны только через бота и веб-панель
- Прямой доступ к файлам через веб-интерфейс ограничен
- Рекомендуется регулярно обновлять видеоинструкции

## Связанные документы

- [Настройка и использование видеоинструкций](../guides/admin/video-instructions-setup.md) — Практическое руководство по настройке и использованию
- [README видеоинструкций](../../video_instructions/README.md) — Техническое описание структуры файлов

---

*Документация создана: 29.09.2025*  
*Последнее обновление: 15.01.2025*  
*Версия проекта: 4.24.0*
