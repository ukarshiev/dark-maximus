...
## Причина
В настройках домена указан `http://localhost:50000`, но ЮKassa не может достучаться до localhost.
...
- **Домен**: `http://localhost:50000` ❌ (нужно изменить)
- **Webhook URL**: `http://localhost:50000/yookassa-webhook` ❌ (недоступен для ЮKassa)
