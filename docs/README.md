...
| **[🧭 reference/admin-panel/](reference/admin-panel/)** | Справочники по админ-панели | API-потоки, клавиатуры бота |
...
| **[🗂️ internal/wiki/](internal/wiki/)** | Внутренние шаблоны Wiki | Docsify шаблоны, карта разделов |
...
|----------|----------|----------|
| **[🚀 Установка](tutorials/admin/installation.md)** | Полное руководство по установке Dark Maximus | Администраторы |
...
| Документ | Описание | Для кого |
|----------|----------|----------|
| **[🧭 Справочник клавиатур бота](reference/admin-panel/menus-reference.md)** | Полный обзор reply и inline-клавиатур, их условия и переходы | Администраторы, операторы поддержки |
| **[🔌 Обзор API панели](reference/admin-panel/api-overview.md)** | Консолидированный список эндпоинтов и вебхуков | Администраторы, интеграторы |
