...
> Примечание 13.11.2025: После последующей реорганизации контент из `docs/user-docs` перенесён в разделы `docs/guides/`, `docs/tutorials/`, `docs/reference/admin-panel/` и `docs/internal/wiki/`. Данный отчёт хранится для истории.
