...
> Примечание 13.11.2025: План сохранён в архивных целях. Текущая структура зафиксирована в `docs/architecture/documentation-structure.md`; каталог `docs/user-docs` удалён, контент распределён по новым разделам.
