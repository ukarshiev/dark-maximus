...
Он автоматически получит SSL-сертификат, настроит Nginx для всех сервисов и запустит Docker-контейнеры.

**5. Завершение:**

После завершения работы скрипта вы увидите сообщение с адресами всех сервисов и данными для первого входа.
...
- [Admin Quickstart](admin-quickstart.md) - быстрый старт для администраторов
- [Admin Panel Guide](admin-panel-guide.md) - полное руководство по админ-панели
