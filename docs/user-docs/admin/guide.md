...
> **URL:** http://localhost:50000/login
...
**Композиция страницы.** Слева расположено вертикальное меню с вкладками (*Серверы*, *Панель*, *Бот*, *Платежи*, *База данных*, *Бекапы*, *Справочники*), справа — детали выбранного раздела. На мобильных устройствах меню автоматически превращается в горизонтальную навигацию с прокруткой, которая появляется над формами настроек.
