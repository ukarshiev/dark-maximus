...
> 📚 **Админская документация доступна на `http://localhost:50001/`**
> - работает на **MkDocs Material** и собирается из каталога `docs/`
> - локальный предпросмотр:  
>   ```bash
>   pip install .[docs]
>   mkdocs serve
>   ```  
> - продакшн-сборка в контейнере: `docker compose build docs && docker compose up -d docs`
> - в навигации доступны руководства, интеграции, справочники и чек-листы безопасности
...
**TON:** `UQCEol-SO6nMn1bH_VdVaXYupmAFUTTKnsvO4Htx_6DDO3nS`
